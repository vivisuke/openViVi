...
protected:
	...
	void	paintLineNumberArea(QPainter&);
	...
	void	paintLineCursor(QPainter&);
	void	paintMatchedBG(QPainter&);
	void adjustPx1Px2(const int& lineStart, const int& last, const pos_t& pos, int& px1, int& px2, const int& matchLength);
	void	paintMatchedBG(QPainter &, int ln, int py);
	void	paintCurWordBG(QPainter &, int ln, int py);
	void	paintEmphasizedBG(QPainter &, int ln, int py, int &eix);
	void	paintAssocParenBG(QPainter &);
	void	paintAssocParenBG(QPainter &, int vln, int py);
	void	paintSelection(QPainter&);
	void	paintMinMap(QPainter&);
